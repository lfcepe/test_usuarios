...
using Devsu.Clientes.Api.Configuracion;
using Devsu.Clientes.Api.Middleware;
...
constructor.Services
    .AddHealthChecks()
    .AddDbContextCheck<ClientesDbContext>("base-datos", tags: new[] { "ready" });
...
{
    opciones.SwaggerEndpoint("/swagger/v1/swagger.json", "Clientes v1");
    opciones.DocumentTitle = "Devsu - Clientes";
});
